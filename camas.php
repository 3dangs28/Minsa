<?php include("inc/librerias.php"); ?>
  ...
  <?php include("modalCamas/modal_agregar.php");?>
  <?php include("modalCamas/modal_modificar.php");?>
  <?php include("modalCamas/modal_eliminar.php");?>
